...
const CardMoviesComponents = ({data,mediaType}) => {
    ...
    const vote_average = parseInt(data.vote_average); // for single vote value

    const original_language = data.original_language; // it will show the language

    const release_date = data.release_date || data.first_air_date; // if moive ti wii show yhe realse date atherwise it will show the started date for serial
      return (
    <>
